...
class FeaturedItem extends StatelessWidget {
  const FeaturedItem({super.key, required this.featuredModel, this.onTap, this.child});

  final FoodModel featuredModel;
  final VoidCallback? onTap;
  final Widget? child;

  factory FeaturedItem.loading() => FeaturedItem(
        featuredModel: FoodModel.empty(),
        child: ClipRRect(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: FoodDeliveryImage(
                          pathOrUrl: featuredModel.imagePath ?? '',
